...
class _RegisterPageState extends State<RegisterPage> {
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(children: [
              ...
              verticalSpacer(32),
              ButtonWidget(label: creatingAccount ? "Creating account" : "Register", onClick: createAccount),
              Padding(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => navigate(context, screen: const LoginPage()),
                      child: Container(
  ...
  void createAccount() {
    if(_form.currentState!.validate() && !creatingAccount) {
      setState(()  => creatingAccount = true);
      navigate(context, screen: const DashboardPage(), type: NavigationType.push);
    }
  }
}
